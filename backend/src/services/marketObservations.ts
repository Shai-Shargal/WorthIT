...
import { MarketObservationModel } from '../db/models/MarketObservation.js';
import type { MarketObservation } from '../types.js';

export interface ObservationQuery {
  name: string;
  currency?: string;
  /** Only return observations newer than this many days. */
  sinceDays?: number;
  /** Only return observations older than this many days (for historical window). */
