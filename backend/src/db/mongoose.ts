...
export async function connectMongo(): Promise<void> {
  ...
  // We don't throw here to keep the core MVP usable even if Mongo is down.
  try {
    // If the connection is already established, re-connecting is harmless but wastes time.
